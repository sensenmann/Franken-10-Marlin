...
// RH: mehr als 20 cm/sec sollten es nicht sein!


#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 300, 30, 200 } // ...or, set your own edit limits
#endif
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (50*60)   // This has effect to sensorless homing!!!
